...
model = YOLO("models/yolo11n-pose.pt")  # 加载预训练模型（建议用于训练）
_epochs = 30
...
if __name__ == "__main__":
    ...
    model.train(data="yoloPoseTrain.yaml", epochs= _epochs, multi_scale=True, profile=True, fliplr=0.0)  # 训练模型
